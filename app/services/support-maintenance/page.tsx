...
export default function SupportMaintenancePage() {
  return (
    <>
      <HireHero small="Service" title="Support & Maintenance" taglineTitle="Always fast, always online." taglineText="Updates, backups, security, and speed optimisation — all handled for you." />
      <main>
        {/* STATS */}
